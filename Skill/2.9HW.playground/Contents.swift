...
//switch может работать не только с логическими операторами. Ну и плюс удобнее и пратичнее его использовать при большом количестве вариантов выполнения кода
